CDRC 2011 Census Geodata pack - Tower Hamlets (E09000030):

+ Abstract
This census data pack provides 2011 Census estimates for the 'Key Statistic' and 'Quick Statistic' tables within the Local Authority District: Tower Hamlets (E09000030) at the Output Area, Lower Super Output Area and Middle Super Output Area scale. The estimates are as at census day, 27 March 2011.
...
+ Contents
	 ...
	 - tables: Folder containing the OA, LSOA and MSOA 2011 Census data for the Local Authority District: Tower Hamlets (E09000030)
	 - shapefiles: Folder containing the OA, LSOA and MSOA digital boundaries as shapefiles for the Local Authority District: Tower Hamlets (E09000030)
